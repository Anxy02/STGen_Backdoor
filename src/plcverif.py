    ...
    for i, property in enumerate(properties_to_be_validated, start=1):
        ...
        if backend == "nusmv":
            ...
            if os.path.exists(smv_cex_file):
                ...
                result_summary += "\nVerification could not be completed due to failed smv file generation"
...
if __name__ == "__main__":
    ...
    properties_to_be_validated = [
    {
        "property_description": "Verify that the sum of stored products and free spaces always equals the total capacity (9)",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-invariant",
            "pattern_params": {
                "1": "instance.productNum + instance.libFreeNum = 9"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "{instance.productNum + instance.libFreeNum = 9} is always true at the end of the PLC cycle."
        }
    },
    {
        "property_description": "Verify that product count never becomes negative",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-invariant",
            "pattern_params": {
                "1": "instance.productNum >= 0"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "{instance.productNum >= 0} is always true at the end of the PLC cycle."
        }
    },
    {
        "property_description": "Verify that an error is triggered if a storage request is made but no slot is found while productNum < 9",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-implication",
            "pattern_params": {
                "0": "instance.requestIn AND NOT instance.found AND NOT instance.productNum >= 9",
                "1": "instance.error"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "If {instance.requestIn AND NOT instance.found AND NOT instance.productNum >= 9} is true at the end of the PLC cycle, then {instance.error} should always be true at the end of the same cycle."
        }
    },
    {
        "property_description": "Verify that storage full condition sets the correct error when productNum reaches 10",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-implication",
            "pattern_params": {
                "0": "instance.productNum = 10 AND instance.requestIn",
                "1": "instance.error AND instance.status = 16#8001"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "If {instance.productNum = 10 AND instance.requestIn} is true at the end of the PLC cycle, then {instance.error AND instance.status = 16#8001} should always be true at the end of the same cycle."
        }
    },
    {
        "property_description": "Verify that storage empty condition sets the correct error when productNum is zero and no product is found",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-implication",
            "pattern_params": {
                "0": "instance.productNum = 0 AND instance.requestOut AND NOT instance.found",
                "1": "instance.error AND instance.status = 16#8002"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "If {instance.productNum = 0 AND instance.requestOut AND NOT instance.found} is true at the end of the PLC cycle, then {instance.error AND instance.status = 16#8002} should always be true at the end of the same cycle."
        }
    },
    {
        "property_description": "Verify that found flag is reset when no requests are active",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-implication",
            "pattern_params": {
                "0": "NOT (instance.requestIn OR instance.requestOut)",
                "1": "NOT instance.found"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "If {NOT (instance.requestIn OR instance.requestOut)} is true at the beginning of the PLC cycle, then {NOT instance.found} is always true at the end of the same cycle."
        }
    },
    {
        "property_description": "Verify that error remains cleared when no requests are active",
        "property": {
            "job_req": "pattern",
            "pattern_id": "pattern-implication",
            "pattern_params": {
                "0": "NOT (instance.requestIn OR instance.requestOut)",
                "1": "NOT instance.error"
            },
            "entry_point": "FB_WarehouseManagement",
            "pattern_description": "If {NOT (instance.requestIn OR instance.requestOut)} is true at the beginning of the PLC cycle, then {NOT instance.error} is always true at the end of the same cycle."
        }
    }
]
    ...
    result = plcverif_validation("/home/Agents4ICS/test/test.ST", properties_to_be_validated,
